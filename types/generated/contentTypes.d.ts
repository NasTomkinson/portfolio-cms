...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      [
        'composite.accordions',
        'composite.bento',
        'composite.logo-cloud',
        'composite.cta-section',
        'composite.contact-form',
        'composite.generic-content',
        'composite.projects',
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroCopy: Schema.Attribute.String;
    heroCopyHeading: Schema.Attribute.String;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    brandColour: Schema.Attribute.String;
    ...
    descriptor: Schema.Attribute.Component<
      'composite.projects-descriptors',
      true
    >;
    introduction: Schema.Attribute.Text;
    languages: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
